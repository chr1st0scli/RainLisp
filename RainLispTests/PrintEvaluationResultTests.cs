...
namespace RainLispTests
{
    public class PrintEvaluationResultTests
    {
        ...
        [Theory]
        [InlineData("+", "[PrimitiveProcedure] Add")]
        [InlineData("-", "[PrimitiveProcedure] Subtract")]
        [InlineData("*", "[PrimitiveProcedure] Multiply")]
        [InlineData("/", "[PrimitiveProcedure] Divide")]
        [InlineData("%", "[PrimitiveProcedure] Modulo")]
        [InlineData(">", "[PrimitiveProcedure] GreaterThan")]
        [InlineData(">=", "[PrimitiveProcedure] GreaterThanOrEqualTo")]
        [InlineData("<", "[PrimitiveProcedure] LessThan")]
        [InlineData("<=", "[PrimitiveProcedure] LessThanOrEqualTo")]
        [InlineData("=", "[PrimitiveProcedure] EqualTo")]
        [InlineData("xor", "[PrimitiveProcedure] LogicalXor")]
        [InlineData("not", "[PrimitiveProcedure] LogicalNot")]
        ...
        [InlineData("null?", "[PrimitiveProcedure] IsNull")]
        [InlineData("set-car!", "[PrimitiveProcedure] SetCar")]
        [InlineData("set-cdr!", "[PrimitiveProcedure] SetCdr")]
