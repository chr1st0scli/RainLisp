...
namespace RainLispTests
{
    public class ParserTests
    {
        ...
        // Missing expressions.
        [InlineData("quote", 1, 1, ParsingError.Expression)]
        [InlineData("set!", 1, 1, ParsingError.Expression)]
        [InlineData("define", 1, 1, ParsingError.Expression)]
        [InlineData("if", 1, 1, ParsingError.Expression)]
        [InlineData("cond", 1, 1, ParsingError.Expression)]
        [InlineData("else", 1, 1, ParsingError.Expression)]
        [InlineData("begin", 1, 1, ParsingError.Expression)]
        [InlineData("lambda", 1, 1, ParsingError.Expression)]
        [InlineData("let", 1, 1, ParsingError.Expression)]
        [InlineData("and", 1, 1, ParsingError.Expression)]
        [InlineData("or", 1, 1, ParsingError.Expression)]
        ...
        [InlineData("a define ", 1, 1, ParsingError.MissingSymbol, TokenType.LParen)]
